...
export default function PackageDetail() {
  ...
  const handleProductItemClick = ({ product }: { product: object }) => {
          ...
          {products.map((product, index) => {
            return (
              <div
                ...
                onClick={() => {
                  handleProductItemClick({ product: product });
                }}
              >
                <img
                  className={styles.productThumbnail}
                  src={EspressoMachineImage}
                />
                <div className={styles.productInfoContainer}>
                  <p className={styles.productName}>바디프렌즈 에스프레소</p>
                ...
                {isEdit ? (
                  <button className={styles.deleteProductButton}>
                    <img
        ...
        <div className={styles.overlay} onClick={() => setIsModalOpen(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalButtonContainer}>
              <DefaultButton
                event={handleBuyConfirmButtonClick}
                isActive={true}
              />
            </div>
          </div>
